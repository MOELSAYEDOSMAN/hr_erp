...
export class EmployeeService {
  ...
  {
    return this.httpclient.post<ListDataDto<Employee>>(`${environment.apiUrl}${this.baseController}/GetAll?page=${page}&count=${count}`,this.httpOptions)
  }

  filter(emp:Employee|null,page:number,count:number):Observable<ListDataDto<Employee>>
  {
    return this.httpclient.post<ListDataDto<Employee>>(`${environment.apiUrl}${this.baseController}/GetAllWithFilter?page=${page}&count=${count}`,emp,this.httpOptions)
  }
